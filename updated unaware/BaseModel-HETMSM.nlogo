...
__includes ["Data.nls" "Table3.nls" "testing-frequency.nls" "manage-age-group.nls" "manage-undiagnosed.nls" "set-dropout-care.nls"
  ...
  "concurrency-HET-MSM.nls" "verify-plot.nls" "write-output.nls" "FiniteQLearningUpdate.nls" "OptimalPolicyUpdate.nls"]
...
;  carefully [file-delete _fname2] []
  ...
  [setup
    reset-ticks
    repeat maxTicks [go];; RUNS UNTIL 2015
...
to go
 ...
 ; export-world "World-Results-0.csv"

  if ticks = sim-dry-run + time-unit * dry-run[
  ;  export-world "World-Results-dryrun1.csv"
  ]
  ...
  ; export-world "World-Results-dryrun2.csv"
      ]
   tick]
...
to add-infected
  ...
  if num-trans-One > 0
  [initialize-transmissions num-trans-One stage 1]
  if num-trans-Two > 0
  [initialize-transmissions num-trans-Two stage 1];;; This person is the main partner for the concurrent partner he/she infected
  if num-trans-Casual > 0
  [initialize-transmissions num-trans-Casual stage 3]
  if num-trans-Needle > 0
  [initialize-transmissions num-trans-Needle stage 4]
...
print  numActsConHET</final>
    <exitCondition>;count people with [dead = 0 and index-patient? = false and infected? = true] = 0 and ticks &gt; sim-dry-run + time-unit * num-year-trans
ticks &gt; (sim-dry-run + time-unit * num-year-trans)
;count people with [dead = 0 and infected-2013-2022? = true] = 0 and ticks &gt; sim-dry-run + time-unit * 20;; at least past 2011
export-world "BaseModel-HETMSM world-10000-6-20-2015.csv"</exitCondition>
    <enumeratedValueSet variable="goal">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="prep-effectiveness">
  ...
  <experiment name="ExperimentRL" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="propAnal">
      <value value="0.5"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="BisexualMix">
      <value value="0.7"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
